...
import { PostProps } from "@/app/types/PostProps";
...
export const PostEditForm: FC<PostProps> = ({ post }) => {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="h-full">
      ...
      <button disabled={isSubmitting} className="block bg-blue-400 rounded-3xl w-48 mx-auto text-white py-2 hover:bg-blue-300">更新する</button>
    </form>
  );
};