...
// PATCH /api/proxy/user_social_profiles/[id]
export async function PATCH(req: NextRequest, segmentData: { params: Promise<{ id: string }> }) {
  ...
  // Rails API PATCH
  const apiRes = await fetch(`${process.env.API_URL}/v1/user_social_profiles/${id}`, {
    method: "PATCH",
    headers: {
...
// DELETE /api/proxy/user_social_profiles/[id]
